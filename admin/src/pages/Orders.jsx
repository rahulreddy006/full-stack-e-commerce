      ...
      <div>
        {
          ...
          orders.map((order, index) => {
            return (
              <div className='grid gird-cols-1 sm:grid-cols-[0.5fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_1fr_1fr_1fr] gap-3 items-start border boder-gray-200 p-5 md:p-8 my-3 md:my-4 text-xs sm:text-xs sm:text-sm text-gray-700' key={index}>
